  ...
  <div class="container-fluid">
    ...
    <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="<?= base_url('profile_user/'.$detailWtch['id']); ?>">
                <span class="material-symbols-outlined">person</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('view_datamovies/'.$detailWtch['id']); ?>">
...
<section id="profile">
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" >
            ...
            <div class="carousel-item active">
                <div class="cards-wrapper" style="justify-content: center; display: flex">
                    <div class="card" style="width: 18rem; margin: 0 0.5em; box-shadow:2px 6px 8px 0 rgba(22,22,26,0.18); border: none; border-radius: 0;">
                        ...
                        <form method="post" action="<?= base_url('wrap/update_watchlist/'.$detailWtch['id'].'/'.$detailWtch['local_id']."/"); ?>">
                            <div class="card-body">
                            <h5 class="card-title">Mr.Robot</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <input type="hidden" id="custId" name="movie_genre" value="Crime">
                            <input type="hidden" id="custId" name="movie_name" value="mrb">
     ...
     <form action="<?= base_url('profile_user/'.$detailWtch['id']); ?>">
