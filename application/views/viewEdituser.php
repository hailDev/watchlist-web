  ...
  <div class="container-fluid">
    ...
    <section id="home" class="jumbotron" style="padding-top: 7rem">
        <div class="card o-hidden border-0 shadow col-md-6 justify-content-center offset-md-3" style="background: radial-gradient(#f8f8ff,#dcdcdc); height: auto; ">
            ...
            <form class="user" method="post" action="<?= base_url('wrap/update_user/'.$detailId['id']); ?>">
                <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="inputnama" placeholder="Name" name="name" value="<?= $detailId['name'];?>">
                        <?= form_error('name', '<small class="text-danger pl-2">', '</small>');?>
                </div>
                <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="inputemail" placeholder="Email" name="email" style="margin-top: 5px" value="<?= $detailId['email'];?>">
                        <?= form_error('email', '<small class="text-danger pl-2">', '</small>');?> 
                </div>
                <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="inputage" placeholder="Age" name="age" style="margin-top: 5px" value="<?= $detailId['age'];?>">
                        <?= form_error('age', '<small class="text-danger pl-2">', '</small>');?>
                </div>
                <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="inputgenre" placeholder="Favorite genre" name="genre" style="margin-top: 5px" value="<?= $detailId['genre'];?>">
